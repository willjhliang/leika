...
multi-slider cancellation, the color picker, notifications, light/dark
theming, multi-client updates, image/Plotly pane lifecycle, resizing and persistence, and responsive
