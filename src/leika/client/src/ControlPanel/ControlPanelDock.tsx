...
import { ControlDockPersistence } from "./ControlDockPersistence";
import { CONTROL_PANEL_ID } from "./controlDockConstants";
...
export function ControlPanelDockSurface({
  ...
  const workspaceId = viewer.useGui((state) => state.workspaceId);
