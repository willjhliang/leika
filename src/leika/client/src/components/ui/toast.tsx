...
/**
 * Per-toast options Leika attaches through the manager's `data` field, for
 * things the toast object itself has no slot for. The server's notification
 * protocol can ask for a toast that the user cannot dismiss by hand.
 */
export type ToastData = { closeButton?: boolean }
...
function Toaster({
  ...
  /** Placement overrides for the viewport, which defaults to bottom-right. */
  className?: string
