...
const badgeVariants = cva(
  // No focus/invalid halo: this client indicates both with a border colour
  // change alone, so the ring utilities are dropped here the same way they
  // were across the other generated components.
